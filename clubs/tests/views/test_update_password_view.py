"""Tests for the updating password view."""
from django.contrib import messages
from django.contrib.auth.hashers import check_password
from django.test import TestCase
from django.urls import reverse
from clubs.form import UpdatePasswordForm
...
class UpdatePasswordViewTest(TestCase):
    ...
    def test_password_url(self):
        self.assertEqual(self.url, '/edit_password/')
    ...
    def test_get_password(self):
        ...
        self.assertTrue(isinstance(form, UpdatePasswordForm))
