...
class UserModelTestCase(TestCase):
    ...
    def test_bio_may_be_unique(self):
        second_user = self._create_second_user()
    ...
    def _create_second_user(self):
        user = User.objects.create_user(
            ...
            personal_statement='this is Jane doe',
            is_staff=False,
            is_superuser=False,
            is_active=True
        )
